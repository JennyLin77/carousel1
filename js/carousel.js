...
carousel.prototype = {
	...
	move: function(offsetDistance){
		...
		thisObj.timer = setInterval(function(){
			var moveDistance = offsetDistance - thisObj.picList.offsetLeft;
			(thisObj.picList.offsetLeft == offsetDistance) ? clearInterval(thisObj.timer) : (thisObj.picList.style.left = thisObj.picList.offsetLeft + moveDistance + "px");
		}, 0);
	}
};
